...
class CartViewset(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Regular authenticated users can only view their own carts
...
class CartItemViewset(viewsets.ModelViewSet):
    ...
    def get_queryset(self):                                           # this part is to find the specific user's specific food that he orders or not
        ...
        if (customer_id and customer_id not in ['null', 'undefined']) and (fooditem_id and fooditem_id not in ['null', 'undefined']):
